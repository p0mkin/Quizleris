...
let currentLanguage: Language = 'lt'; // Default to Lithuanian

// Initialize language from localStorage or default
export function initLanguage(): void {
    const saved = localStorage.getItem('quiz_language') as Language | null;
...
export function updatePageLanguage(): void {
