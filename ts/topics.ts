...
import { setupMenu, renderStartMenu } from "./menu.js";
...
export function renderTopicsPage(): void {
    ...
    let topicsContainer = startMenu.querySelector(".topics-page-container") as HTMLElement;
    if (topicsContainer) {
...
function renderBundleCard(bundle: Quiz): string {
...
function startTopicQuiz(quiz: Quiz): void {
